...
for i=1:length(DR)
   ...
   pt(i,:)=1./(1+(1/DR(i)).*(vh./vt)); %Same calculation just another form
   ptl(i,:)=1-((((DR(i).*vtl)./vh)+1).^-1);
...
loglog(vtl./vh,100*DF2l(1,:),'k--','LineWidth',2); %Ru
hold on;
loglog(vtl./vh,100*DF2l(2,:),'r.-','LineWidth',1.5,'MarkerSize',20); %Zr
loglog(vtl./vh,100*DF2l(3,:),'bo-','LineWidth',1.5,'MarkerSize',8);  %Nb
loglog(vtl./vh,100*DF2l(4,:),'g*-','LineWidth',1.5,'MarkerSize',10); %RE
...
loglog(vtl./vh,100*DF2Cl(1,:),'k--','LineWidth',4); %Ru
hold on;
loglog(vtl./vh,100*DF2Cl(2,:),'r.-','LineWidth',2,'MarkerSize',20); %Zr
loglog(vtl./vh,100*DF2Cl(3,:),'bo-','LineWidth',2,'MarkerSize',8);  %Nb
loglog(vtl./vh,100*DF2Cl(4,:),'g*-','LineWidth',2,'MarkerSize',10); %RE
loglog(vtl./vh,100*DFOAl(1,:),'kx-','LineWidth',2,'MarkerSize',12); %Sum
...
loglog(vtl./vh,100*DFl(3,:),'bo-','LineWidth',1.5,'MarkerSize',8);  %Nb
loglog(vtl./vh,100*DFl(4,:),'g*-','LineWidth',1.5,'MarkerSize',10); %RE
loglog(vtl./vh,100*DFOA2(1,:),'kx-','LineWidth',2,'MarkerSize',12); %Sum
...
loglog(vtl./vh,100*DF4Cl(1,:),'k^-','LineWidth',2,'MarkerSize',10); %Ru
hold on;
loglog(vtl./vh,100*DF4Cl(2,:),'r.-','LineWidth',2,'MarkerSize',20); %Zr
loglog(vtl./vh,100*DF4Cl(3,:),'bo-','LineWidth',2,'MarkerSize',8);  %Nb
loglog(vtl./vh,100*DF4Cl(4,:),'g*-','LineWidth',2,'MarkerSize',10); %RE
...
%%%%%%%%%%%%%%%%%%%%%%%%%% Plot the first pass again to compare
loglog(vtl./vh,100*DFl(1,:),'k^-','LineWidth',1.5,'MarkerSize',10); %Ru
hold on;
loglog(vtl./vh,100*DFl(2,:),'r.-','LineWidth',1.5,'MarkerSize',20); %Zr
loglog(vtl./vh,100*DFl(3,:),'bo-','LineWidth',1.5,'MarkerSize',8);  %Nb
loglog(vtl./vh,100*DFl(4,:),'g*-','LineWidth',1.5,'MarkerSize',10); %RE
...
hold on;
loglog(ones(1,N)*1.4,logspace(2,5,N),'m','LineWidth',2.5)
xlim([0.0015,4])
